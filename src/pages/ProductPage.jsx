  ...
  return (
    <div>
        ...
        mobile:mt-3 mobile:p-3">
            ...
            <div
                className="flex-[1.3] flex items-start
                justify-items-start flex-col mt-10 mobile:items-center"
            >
                <h1
                ...
                <div className="flex text-2xl mt-7">
                    ...
                    border-2 p-[10px] cursor-pointer ml-5
                    hover:border-[#8a4af3]">
                    </div>
                    <div
                        className="
